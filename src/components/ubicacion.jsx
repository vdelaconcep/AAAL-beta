...
const Ubicacion = () => {
    return (
        <section className="bg-[#A0AB94] border-b-[2px] border-b-[#858f7b] w-full pt-1 md:pt-3 pb-4 md:pb-5">
            <h1 className="pl-4 mb-2 md:mb-5 pt-3 md:pt-4 font-bold text-lg md:text-xl italic text-gray-900">Dónde estamos</h1>
            <article className="px-4 md:pr-8 flex flex-col items-center md:justify-between md:h-[456px]">
