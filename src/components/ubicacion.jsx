...
const Ubicacion = () => {
    return (
        <section className="fondo-verde borde-inferior-verde-oscuro w-full pt-1 md:pt-4 pb-4 md:pb-5">
            <motion.div
