...
const Historia = () => {
    ...
    const claseParrafosOcultos = `pb-4 ${verMas ? "block" : "hidden md:block"}`;

    return (
        <section
            className="fondo-celeste borde-inferior-celeste-oscuro w-full pt-1 md:pt-4 md:pb-3 px-4 md:px-8">
            ...
            <motion.div
                ...
                <article
                    className={`relative md:columns-2 md:gap-8 text-gray-200 text-sm md:text-md ${verMas ? "" : "max-h-48 overflow-hidden md:max-h-none md:overflow-visible"}`}>
                    <div>
                        <p className="pb-4">
                        ...
                        <p className={claseParrafosOcultos}>
                    ...
                    <div>
                        ...
                        <p className={claseParrafosOcultos}>¡Muchas gracias por visitarnos!</p>
                    </div>

                    {!verMas && (
                        <span className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-[#6B9795] to-transparent pointer-events-none z-0 md:hidden"></span>
                    )}
                </article>
            </motion.div>
            ...
            <div className="text-black font-medium flex flex-col items-center relative z-10 md:hidden">
                ...
                >
                    <i
                        className={`fa-solid ${verMas ? "fa-chevron-up" : "fa-chevron-down mt-[-30px]"
                            } mb-[-7px]`}
                    ></i>
