...
const Header = () => {
    ...
    // Responsive
    const fontSizeTitulo = 'text-[1.3rem] min-[350px]:text-[1.5rem] min-[400px]:text-[1.6rem] min-[500px]:text-[2.2rem] sm:text-5xl lg:text-6xl'
        ...
        <header className='bg-linear-to-b from-[#350a1b] to-[#8a1a47] py-3'>
            <div className='flex min-[420px]:gap-1 text-white justify-center items-center w-full'>
                ...
                <article className='flex-col items-center justify-center text-center'>
                    ...
                    <h5 className='text-center italic text-[11.8px] sm:text-sm md:text-lg lg:text-xl sm:mt-1 text-[#DECBA0] md:mt-2'>Fundada el 24 de septiembre del 2000</h5>
                </article>
            </div>
        </header>
    );
