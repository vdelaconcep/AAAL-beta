...
const Footer = () => {
    return (
        <footer className="bg-black px-4 pt-8 md:pt-10 pb-8 min-[450px]:text-center">
            ...
            <a className="text-white text-[17px] md:text-lg border-[1px] border-gray-500 rounded-md p-1 px-2" href="https://www.instagram.com/aaalanus?igsh=dmhzeG5pZ2NuMHVt" title='Ir a página de Instagram de AAAL' target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-instagram bg-gradient-to-tr from-[#F57621] via-[#F41267] to-[#7C32A9] font-extrabold text-transparent bg-clip-text"></i> Seguinos en Instagram</a>
